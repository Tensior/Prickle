...
namespace Core
{
	public class CharacterController2D : MonoBehaviour
	{
		...
		public LayerMask PlatformMask; //determine what exactly layers we're gonna use to collide on
		...
		//it will return _overrideParameters however if it's null it'll return default parameters
		...
		private void Move(Vector2 deltaMovement)
		{
			...
			if (HandleCollisions)
			{
				...
				if (deltaMovement.y < 0 && wasGrounded)
					HandleVecticalSlope(ref deltaMovement);
		...
		private void CorrectHorizontalPlacement(ref Vector2 deltaMovement, bool isRight)
		{
			...
			for (var i = 1; i < TotalHorizontalRays; i++)
			{
				...
				offset = isRight ? ((_transform.position.x - raycastHit.point.x) + halfWidth) : (halfWidth - (_transform.position.x - raycastHit.point.x));
			}
		...
		private void HandleVecticalSlope(ref Vector2 deltaMovement)
		{ 
